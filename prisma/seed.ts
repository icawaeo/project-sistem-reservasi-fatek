...
const userSeeds: SeedUser[] = [
  ...
  // Kaprodi (8 program studi)
  {
    name: "Kaprodi Informatika Dummy",
    email: "kaprodi-it@unsrat.ac.id",
    identifier: "19871501",
    rank: "Penata",
    position: "Koordinator Program Studi Informatika",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "IT",
  },
  {
    name: "Kaprodi Elektro Dummy",
    email: "kaprodi-elektro@unsrat.ac.id",
    identifier: "19871502",
    rank: "Penata",
    position: "Koordinator Program Studi Teknik Elektro",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "ELEKTRO",
  },
  {
    name: "Kaprodi Arsitektur Dummy",
    email: "kaprodi-arsitektur@unsrat.ac.id",
    identifier: "19871503",
    rank: "Penata",
    position: "Koordinator Program Studi Arsitektur",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "ARSITEKTUR",
  },
  {
    name: "Kaprodi PWK Dummy",
    email: "kaprodi-pwk@unsrat.ac.id",
    identifier: "19871504",
    rank: "Penata",
    position: "Koordinator Program Studi PWK",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "PWK",
  },
  {
    name: "Kaprodi Sipil Dummy",
    email: "kaprodi-sipil@unsrat.ac.id",
    identifier: "19871505",
    rank: "Penata",
    position: "Koordinator Program Studi Teknik Sipil",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "SIPIL",
  },
  {
    name: "Kaprodi Lingkungan Dummy",
    email: "kaprodi-lingkungan@unsrat.ac.id",
    identifier: "19871506",
    rank: "Penata",
    position: "Koordinator Program Studi Teknik Lingkungan",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "LINGKUNGAN",
  },
  {
    name: "Kaprodi Mesin Dummy",
    email: "kaprodi-mesin@unsrat.ac.id",
    identifier: "19871507",
    rank: "Penata",
    position: "Koordinator Program Studi Teknik Mesin",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "MESIN",
  },
  {
    name: "Kaprodi Industri Dummy",
    email: "kaprodi-industri@unsrat.ac.id",
    identifier: "19871508",
    rank: "Penata",
    position: "Koordinator Program Studi Teknik Industri",
    userType: "STAFF",
    role: USER_ROLES.KAPRODI,
    programScope: "INDUSTRI",
  },
  ...
  {
    name: "Kepala Lab Industri Dummy",
    email: "kalab-industri@unsrat.ac.id",
    identifier: "19872008",
    rank: "Penata",
    position: "Kepala Lab Industri",
    userType: "STAFF",
    role: USER_ROLES.KEPALA_LAB,
    programScope: "INDUSTRI",
  },
