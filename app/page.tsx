...
import RegisterView from "@/app/components/auth/registerView";
  ...
  return (
      <div className="min-h-screen flex flex-col w-full bg-[radial-gradient(1200px_circle_at_20%_10%,#dbeafe_0%,transparent_55%),radial-gradient(900px_circle_at_80%_30%,#bfdbfe_0%,transparent_60%),linear-gradient(135deg,#c7d2fe_0%,#93c5fd_40%,#60a5fa_100%)] font-sans">
        <div className="flex-1 flex items-center justify-center px-4 py-6">
          <div className="w-full max-w-5xl overflow-hidden rounded-[44px] bg-white/25 backdrop-blur-xl ring-1 ring-white/40 shadow-[0_30px_100px_rgba(2,6,23,0.20)]">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* LEFT COLUMN */}
              <div className="relative p-8 lg:p-10 text-slate-900 bg-white/10 flex flex-col justify-center">
                <h1 className="mt-4 text-3xl lg:text-4xl xl:text-5xl font-extrabold leading-[1.1] tracking-[-0.02em] text-slate-900">
                  Reservasi Ruangan Fakultas Teknik
                  <br />
                  UNSRAT
                </h1>
                <p className="mt-3 max-w-md text-sm lg:text-base text-slate-600 leading-relaxed">
